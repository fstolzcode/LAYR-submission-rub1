...
# UART reference clock on input_PAD[3] - 153.6 kHz asynchronous
create_clock -name uart_clk -period 6510.42 [get_ports {uart_clk_PAD}]
set_clock_groups -asynchronous \
    -group [get_clocks $clock_port] \
    -group [get_clocks uart_clk]

# Input-only pads (excluding input_PAD[3] which is a clock)
