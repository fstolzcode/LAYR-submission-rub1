...
hdl_toplevel = "rubteam1" if gl else "chip_top"
...
def chip_top_runner():
    ...
    # Add awesome-layr tb/ to PYTHONPATH so test_main_controller_app can be imported
    tb_path = str(proj_path / "../src/awesome-layr/tb")
